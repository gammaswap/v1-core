...
export class GammaPool__factory {
  static readonly abi = _abi;
  static createInterface(): GammaPoolInterface {
    return new utils.Interface(_abi) as GammaPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GammaPool {
    return new Contract(address, _abi, signerOrProvider) as GammaPool;
  }
}

...
export interface RebalanceStrategyInterface extends utils.Interface {
  functions: {
...
export interface RebalanceStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RebalanceStrategyInterface;

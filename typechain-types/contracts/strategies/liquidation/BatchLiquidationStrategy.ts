...
export interface BatchLiquidationStrategyInterface extends utils.Interface {
  functions: {
...
export interface BatchLiquidationStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BatchLiquidationStrategyInterface;

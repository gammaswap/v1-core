...
export interface SingleLiquidationStrategyInterface extends utils.Interface {
  functions: {
...
export interface SingleLiquidationStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SingleLiquidationStrategyInterface;

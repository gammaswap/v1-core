...
export interface BaseLiquidationStrategyInterface extends utils.Interface {
  functions: {
...
export interface BaseLiquidationStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseLiquidationStrategyInterface;

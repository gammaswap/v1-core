...
export interface BaseRebalanceStrategyInterface extends utils.Interface {
  functions: {
...
export interface BaseRebalanceStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseRebalanceStrategyInterface;

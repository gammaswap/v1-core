...
export interface BaseExternalStrategyInterface extends utils.Interface {
  functions: {
...
export interface BaseExternalStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseExternalStrategyInterface;

...
export interface BaseLongStrategyInterface extends utils.Interface {
  functions: {
...
export interface BaseLongStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseLongStrategyInterface;

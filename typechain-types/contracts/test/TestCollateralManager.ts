...
export interface TestCollateralManagerInterface extends utils.Interface {
  functions: {
...
export interface TestCollateralManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestCollateralManagerInterface;

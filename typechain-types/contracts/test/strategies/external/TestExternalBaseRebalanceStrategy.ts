...
export interface TestExternalBaseRebalanceStrategyInterface
...
export interface TestExternalBaseRebalanceStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestExternalBaseRebalanceStrategyInterface;

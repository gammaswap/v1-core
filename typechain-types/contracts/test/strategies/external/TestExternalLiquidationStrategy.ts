...
export interface TestExternalLiquidationStrategyInterface
  ...
  encodeFunctionData(functionFragment: "liqFee", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "liqFee", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "liquidationFee",
    data: BytesLike
  ): Result;
...
export interface TestExternalLiquidationStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestExternalLiquidationStrategyInterface;
  ...
  functions: {
    ...
    liqFee(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    ...
    liqFee(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    liqFee(overrides?: CallOverrides): Promise<PopulatedTransaction>;

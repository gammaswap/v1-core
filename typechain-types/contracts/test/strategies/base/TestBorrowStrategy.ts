...
export interface TestBorrowStrategyInterface extends utils.Interface {
  functions: {
    ...
    "setOrigFeeParams(uint8)": FunctionFragment;
    "setOriginationFee(uint16)": FunctionFragment;
    "squareRoot(uint256)": FunctionFragment;
    "testCalcOriginationFee(uint16,uint32,uint8,uint16,uint256,uint256,uint256,uint256)": FunctionFragment;
    ...
    "testUpdateLoanLiquidity(uint256,uint96)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setOrigFeeParams",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testCalcOriginationFee",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  events: {
    "DynOrigFee(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "DynOrigFee"): EventFragment;
...
export interface DynOrigFeeEventObject {
  dynOrigFee: BigNumber;
}
export type DynOrigFeeEvent = TypedEvent<[BigNumber], DynOrigFeeEventObject>;

export type DynOrigFeeEventFilter = TypedEventFilter<DynOrigFeeEvent>;
...
export interface TestBorrowStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestBorrowStrategyInterface;
  ...
  functions: {
    ...
    testCalcOriginationFee(
      ...
      minUtilRate1: PromiseOrValue<BigNumberish>,
      feeDivisor: PromiseOrValue<BigNumberish>,
      liquidityBorrowed: PromiseOrValue<BigNumberish>,
      borrowedInvariant: PromiseOrValue<BigNumberish>,
      lpInvariant: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    "DynOrigFee(uint256)"(dynOrigFee?: null): DynOrigFeeEventFilter;
    DynOrigFee(dynOrigFee?: null): DynOrigFeeEventFilter;

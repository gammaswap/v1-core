...
export interface TestRepayStrategyInterface extends utils.Interface {
  functions: {
...
export interface TestRepayStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestRepayStrategyInterface;

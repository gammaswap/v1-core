...
export interface TestGammaPoolFactory2Interface extends utils.Interface {
  functions: {
    ...
    "setOrigFeeShare2(uint16)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setOrigFeeShare2",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface TestGammaPoolFactory2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestGammaPoolFactory2Interface;

...
interface ILoanObserverStore {
    ...
    function setLoanObserver(uint256 refId, address refAddr, uint16 fee, uint8 typ, bool active, bool restricted) external;
    ...
    /// @dev Get observer for a new loan being opened
    ...
    function getLoanObserver(uint16 refId, address pool, address requester) external view returns(address, uint16, uint8);
}
